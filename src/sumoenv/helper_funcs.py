...
def parse_cl_args():
    ...
    ##sumo params
    parser.add_argument("-sim", type=str, default='double', dest='sim', help='simulation scenario, default: lust, options:lust, single, double')
    ...
    parser.add_argument("-mqtt_host", type=str, default="127.0.0.1", dest='mqtt_host', help='mqtt client host, default: localhost')
    parser.add_argument("-mqtt_port", type=int, default=1883, dest='mqtt_port', help='mqtt client host, default: 1883')
